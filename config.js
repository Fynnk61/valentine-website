...
const CONFIG = {
    ...
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Will You Be My late Valentine? 💝",
    ...
    questions: {
        first: {
            ...
            yesBtn: "Ja, natürlich",                                             // Text for "Yes" button
        ...
        second: {
            ...
            nextBtn: "Nächstes ❤️"                                         // Text for the next button
        },
        third: {
            text: "Will you be my late Valentine on February 15th, 2026? 🌹", // The big question!
    ...
    celebration: {
        title: " Ich bin offiziell der glücklichste Mann der Welt! 🎉💝💖💝💓",
        message: "Ich hoffe es ist iwie okay das ich doch Frage 😬",
